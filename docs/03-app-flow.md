...
| State | Behaviour |
|---|---|
| **Mail app present** | `mailto:` opens with the diagnostics in the body, which the user can delete |
| **No mail app** | Diagnostics shown with a **Copy** button — always leave one working path |

> 🔴 **There is no feedback form and no "This plan looks wrong" entry point.**
> Removed 2026-08-07 — the app collects nothing from its users. See
> [`09-feedback-channel.md`](09-feedback-channel.md).
